...
def run_bot():
    while True:
        ...
        # Вариант 1: split production — использовать, если вы хотите делить производственные мощности на разные товары.
        ...
        # Вариант 2: one production — использовать, если вы хотите производить только один тип товара.
        set_one_production(
            [
                # Примеры шаблонов. Уберите комментарии с нужных строк или добавьте свои.
                # "moonstone/perfect",
                "moonstone/excellent",
                # "obj/stone_crusher",
                # "obj/sword_damocles",
...
if __name__ == "__main__":
    try:
        ...
        print("❌ Bot encountered an unexpected error!")
